...
sudo dpkg -i linux-headers-3.13.0-45_3.13.0-45.74_all.deb  
sudo dpkg -i linux-headers-3.13.0-45-generic_3.13.0-45.74_amd64.deb  
sudo dpkg -i linux-image-3.13.0-45-generic_3.13.0-45.74_amd64.deb
sudo reboot
